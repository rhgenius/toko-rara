...
<html>
<head>
	<title>PRELOVED BUTTONSCARVES RARA</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <i class="glyphicon glyphicon-earphone"></i> +6281398135855</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> prelovedrara@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span> Jl. Pulau Rangas C7/5</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ebaaff"><b>PRELOVED BUTTONSCARVES RARA</b></a>
			</div>
